...
const ImpLinks = (props) => {
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.header}>Import Links</Text>
      <View style={styles.listContainer}>
        <View style={styles.listItem}>
          {/* <Image
            ...
            style={styles.image}
          /> */}
          <Text style={{fontWeight:'bold',color:'#111',fontSize:18}} >Inquiry-form</Text>

          <TouchableOpacity
            style={styles.applyButton}
            // onPress={() => props.navigation.navigate('CustomerApplyForm')}
          >
            <Text style={[styles.applyButtonText, { fontWeight: 'bold' }]}>Click To View</Text>
          </TouchableOpacity>
        </View>
        {[...Array(1)].map((_, index) => (
          ...
          <Text style={{fontWeight:'bold',color:'#111',fontSize:18}} >CSV Link</Text>
            ...
            >
              ...
              <Text style={[styles.applyButtonText, { fontWeight: 'bold' }]}>Download</Text>
            </TouchableOpacity>
          </View>
        ))}
      </View>
