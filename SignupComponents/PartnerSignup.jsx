...
const PartnerSignup = props => {
  ...
  const handleRegister = async () => {
    ...
    props.navigation.navigate('EmpLogin')
    // props.navigation.navigate('LoanData')
    // props.navigation.navigate('CreditCardData')
    // props.navigation.navigate('Hrdata')
    ...
    <View style={styles.RegisterContainer}>
      <ScrollView
        ...
        <View style={styles.imgContainer}>
          ...
          />
          <Text style={styles.heading}>Partner Sign Up</Text>
