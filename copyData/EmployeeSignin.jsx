  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://api.addrupee.com/api/emp_login",
        loginData
      );
      ...
      if (response.data.Status === "Success") {
        ...
        if (userType === "Employee") {
          ...
          localStorage.setItem("employeeTLName", response.data.TL_Name);
          router.push("/employeedashboard");
        } else if (userType === "Team Leader") {
          localStorage.setItem("TL_Name", response.data.name);
          localStorage.setItem("teamLeaderEmail", loginData.email);
          router.push("/tldashboard");
        } else if (userType === "Admin") {
          router.push("/admindashboard/employee");
        } else if (userType === "Hr") {
          localStorage.setItem("hrEmailId", loginData.email);
