...
const SalariedDashboard = ({navigation,props}) => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const mockData = [
        ...
        { title: 'Partner Details', imageSource: require("../images/loanAp.png") },
        { title: 'Customer Data', imageSource: require("../images/loanAp.png") },
        { title: 'Inquiry Data', imageSource: require("../images/loanAp.png") },
        { title: 'Important Links', imageSource: require("../images/loanAp.png") },
      ];
...
export default SalariedDashboard;
